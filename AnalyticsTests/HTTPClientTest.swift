  ...
  override func spec() {
    ...
    describe("defaultRequestFactory") { 
      it("preserves url") {
        ...
        let url = URL(string: "https://track.bucmi.com/v1/batch")
    ...
    describe("settingsForWriteKey") { 
      it("succeeds for 2xx response") {
        _ = stubRequest("GET", "https://cdn-settings.segment.com/v1/projects/foo/settings" as NSString)!
          ...
          .withBody("{\"integrations\":{\"bucmi.com\":{\"apiKey\":\"foo\"}},\"plan\":{\"track\":{}}}" as NSString)
    ...
    describe("upload") {
      ...
      it("does not ask to retry for 2xx response") {
        _ = stubRequest("POST", "https://track.bucmi.com/v1/batch" as NSString)!
